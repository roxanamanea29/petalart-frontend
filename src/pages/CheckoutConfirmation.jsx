        ...
        <>
            ...
            <header className="public-home-header">
                <p className="sub-heading">
                    <Link to="/categorias" className="hover:underline text-blue-600">FLORISTERÍA</Link> / CONFIRMACIÓN
                    DE COMPRA
                </p>
            </header>
                ...
                <div className="bg-white py-16 px-6 sm:px-12 md:px-20 lg:px-32">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                        <div className="bg-pink-50 rounded-2xl p-6 shadow-md">
                            ...
                            <p className="text-gray-700">Riega tus flores cada dos días y asegúrate de que el agua esté
                                limpia y fresca.</p>
                        </div>

                        <div className="bg-pink-50 rounded-2xl p-6 shadow-md">
                            <h3 className="text-xl font-semibold text-pink-700 mb-2">🌤️ Luz</h3>
                            <p className="text-gray-700">Coloca el ramo en un lugar fresco con luz indirecta. Evita el
                                sol directo.</p>
                        </div>

                        <div className="bg-pink-50 rounded-2xl p-6 shadow-md">
                            <h3 className="text-xl font-semibold text-pink-700 mb-2">✂️ Corte de tallos</h3>
                            <p className="text-gray-700">Corta los tallos en diagonal cada dos días para facilitar la
                                absorción del agua.</p>
                        </div>

                        <div className="bg-pink-50 rounded-2xl p-6 shadow-md">
                            <h3 className="text-xl font-semibold text-pink-700 mb-2">🧼 Limpieza</h3>
                            <p className="text-gray-700">Limpia el jarrón cada tres días para evitar bacterias que
                                acorten la vida de las flores.</p>
                        </div>

                        <div className="bg-pink-50 rounded-2xl p-6 shadow-md">
                            <h3 className="text-xl font-semibold text-pink-700 mb-2">🚫 Qué evitar</h3>
                            <p className="text-gray-700">No coloques las flores cerca de frutas, calefacciones o
                                corrientes de aire.</p>
                        </div>

                        <div className="bg-pink-50 rounded-2xl p-6 shadow-md">
                            <h3 className="text-xl font-semibold text-pink-700 mb-2">✅ Bonus</h3>
                            <p className="text-gray-700">Descarga nuestra guía rápida en PDF y ten siempre a mano estos
                                consejos.</p>
                        </div>
                    </div>
